    ...
    <main className="flex flex-1 flex-col items-center">
      ...
      <section className="flex w-full flex-col items-center gap-6 px-6 py-24 text-center">
        <h1 className="max-w-2xl text-4xl font-bold tracking-tight sm:text-6xl">
          Shorten links.{' '}
          <span className="text-muted-foreground">Share instantly.</span>
        </h1>
        <p className="max-w-xl text-lg text-muted-foreground">
          Create short, memorable URLs in seconds and share them across any
          platform — all in one simple dashboard.
        </p>
